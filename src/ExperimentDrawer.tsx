      ...
      <div className="drawer" onClick={e => e.stopPropagation()}>
        ...
        <div className="drawer-content">
          ...
          {activeTab === 'strategy' ? (
            <div className="tab-content transition-in">
              ...
              <div className="form-group">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                  <div className="label">Success Criteria (Definition of Done)</div>
                  <button 
                  ...
                  >
                    <Edit3 size={14} />
                    {editingSuccessCriteria ? 'Cancel' : 'Edit'}
                  </button>
                </div>
                {editingSuccessCriteria ? (
                  <div>
                    <textarea
                      ...
                      placeholder="Define the exact conditions that determine success..."
                      style={{
                        width: '100%',
                        minHeight: '80px',
                        padding: '12px',
                  ...
                  <div className="rich-text" style={{ background: '#F0FDF4', border: '1px solid #86EFAC', borderRadius: '8px', padding: '16px' }}>
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                      ...
                      <div style={{ color: '#166534', fontSize: '14px', lineHeight: '1.6' }}>
                        {experiment.successCriteria || 'Not defined yet. Click "Edit" to specify the exact conditions that determine if this experiment is successful.'}
                      </div>
                    </div>
                  </div>
                )}
              ...
              <div className="form-group">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                  ...
                  >
                    <Edit3 size={14} />
                    {editingTargetMetric ? 'Cancel' : 'Edit'}
                  </button>
                </div>
                {editingTargetMetric ? (
                  <div>
                    <input
                      ...
                      placeholder="E.g., Conversion Rate, Sign-up Rate, NPS Score..."
                      style={{
                        width: '100%',
                        padding: '12px',
                  ...
                  <div style={{ 
                    ...
                    <div>
                      <div style={{ fontSize: '14px', fontWeight: 600, color: '#4F46E5', marginBottom: '4px' }}>
                        {experiment.targetMetric || 'No specific metric set'}
                      </div>
                      <div style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
                        The exact metric this experiment aims to move
                      </div>
                    </div>
                  </div>
                )}
              ...
              {experiment.problem && (
                 <div className="form-group">
                  <div className="label">Problem to Solve</div>
                  <div className="rich-text" style={{ background: 'var(--bg-sidebar)', border: 'none' }}>
                    {experiment.problem}
                  </div>
                 </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', marginTop: '32px' }}>
                <div>
                  <div className="label">Prioritization (ICE)</div>
                ...
                <div>
                  <div className="label">Strategic Context</div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '16px' }}>
                    {/* EDITABLE Linked Strategy Dropdown */}
                    <div>
                      <div className="label" style={{ fontSize: '10px', marginBottom: '8px' }}>Linked Strategy</div>
                      <select
                    ...
                    {parentObjective && (
                      <div>
                        <div className="label" style={{ fontSize: '10px' }}>Parent Objective</div>
                        <div style={{ 
                          display: 'flex', 
                          alignItems: 'center', 
                          gap: '8px', 
                    ...
                    {experiment.source && (
                      <div>
                        <div className="label" style={{ fontSize: '10px' }}>Source</div>
            ...
            <div className="tab-content transition-in">
              <div className="form-group">
                <div className="label">Experiment Lead</div>
                <select
                ...
                <div style={{ 
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Current Owner</div>
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '32px' }}>
                <div>
                  <div className="label" style={{ marginBottom: '8px' }}>Start Date</div>
                  <input 
                    type="date"
                ...
                <div>
                  <div className="label" style={{ marginBottom: '8px' }}>Expected End Date</div>
                  <input 
                    type="date"
                ...
                {editingUrl ? (
                  ...
                  <div style={{ 
                    ...
                    {experiment.testUrl ? (
                      ...
                      <span style={{ color: 'var(--text-subtle)' }}>No URL attached</span>
                    )}
                  </div>
                )}
              </div>
              ...
              <div style={{ marginBottom: '32px' }}>
                 ...
                 {editingLearnings ? (
                   <div>
                     <textarea
                       ...
                       placeholder="Document key insights and learnings from this experiment..."
                       style={{
                         width: '100%',
                         minHeight: '120px',
                         padding: '12px',
                    ...
                    <div style={{ padding: '32px', textAlign: 'center', border: '1px dashed var(--border-subtle)', borderRadius: '8px', color: 'var(--text-subtle)', marginTop: '8px' }}>
                      No learnings recorded yet. Click "Edit" to add insights.
                    </div>
                 )}
              </div>
               ...
               <div>
                 ...
                 <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gap: '12px', marginTop: '12px' }}>
                    ...
                    >
                      <Upload size={24} />
                      <span style={{ fontSize: '12px', fontWeight: 600 }}>Upload Screenshot</span>
                    </button>
                 </div>
              </div>
              ...
              <div style={{ marginTop: '48px', paddingTop: '24px', borderTop: '1px solid var(--border-subtle)' }}>
                ...
                >
                  ...
                  Conclude & Archive Experiment
                </button>
                <div style={{ textAlign: 'center', marginTop: '12px', fontSize: '12px', color: 'var(--text-muted)' }}>
                  {canConclude 
                    ? 'This will move the experiment to the Library' 
                    : 'Set status to "Analysis" to conclude this experiment'}
                </div>
              </div>
            </div>
          )}
